				...
				for($i = 1; $i <= 10; $i++){
					?>
						<label for='question<?= $i; ?>'>
						  <p><?= 'Question Nº ' . $i . ' &mdash; ' . $dataDecoded->$i; ?><br>
							<input type="range" id="question<?= $i; ?>" class="question" name="question<?= $i; ?>" min="1" max="7" onchange="rangevalue<?= $i; ?>.value=value" type="range">
							<output id="rangevalue<?= $i; ?>">4</output>
